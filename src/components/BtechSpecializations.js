...
const specializations = [
    {
        ...
        description: "Master the fundamentals of computing, software development, and modern technologies to build the future of tech."
    },
    {
        ...
        description: "Specialized program focusing on Artificial Intelligence and Machine Learning algorithms, data science, and intelligent systems."
    },
    {
        title: "B.Tech in Mechanical Engineering",
        image: "/img/specialization/btech-in-mechanical-engineering.webp",
        description: "Explore the world of machines, thermodynamics, and manufacturing with hands-on training in modern mechanical systems."
    },
    {
        title: "B.Tech in Electronics & Communication Engineering",
        image: "/img/specialization/btech-in-electronics-and-communication-engineering.webp",
        description: "Design and develop the next generation of communication systems, electronic circuits, and smart devices."
    },
];
        ...
        <section className="py-20 bg-gray-50">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    >
                        Empower your career with our specialized engineering programs designed for the modern industry.
                    </motion.p>
                </div>
